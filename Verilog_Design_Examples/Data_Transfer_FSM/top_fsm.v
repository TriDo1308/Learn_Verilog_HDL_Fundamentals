...
+=================+======================+==============+===================+  
| IDLE            | opmode_in == 1'b1    | READ_BYTE0   | None              |
+-----------------+----------------------+--------------+-------------------+
| IDLE            | opmode_in == 1'b0    | IDLE         | None              |
+-----------------+----------------------+--------------+-------------------+
| READ_BYTE0      | None                 | READ_BYTE1   | ram_in_rd_addr    |
+-----------------+----------------------+--------------+-------------------+
| READ_BYTE1      | None                 | WRITE_BYTE12 | ram_in_rd_addr    |
+-----------------+----------------------+--------------+-------------------+
| WRITE_BYTE12    | done_out == 1        | IDLE         | ram_out_we = 1    |
+-----------------+----------------------+--------------+-------------------+
