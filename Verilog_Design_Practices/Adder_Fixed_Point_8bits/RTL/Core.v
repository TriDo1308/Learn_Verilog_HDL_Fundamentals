module Core (
	...
	wire						Load_a_en_out_w, Load_b_en_out_w;

	wire signed [7:0] 			a_out_w, b_out_w, c_out_w;
	...
	(
		...
		.En_out       (En_out_w       ),
		/* To Input Memory*/
		.Load_a_en_out(Load_a_en_out_w),
		.Load_b_en_out(Load_b_en_out_w),
		/* To TX UART Interface*/
	...
	(
		...
		.RST         (RST            ),
		/* From Controller */
		.Load_a_en_in(Load_a_en_out_w),
		.Load_b_en_in(Load_b_en_out_w),
		/* From TX UART Interface */
		.Rx_Byte_in  (Rx_Byte_in     ),   
		/* To Datapath */
		.a_out       (a_out_w        ),
