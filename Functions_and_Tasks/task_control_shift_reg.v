...
/* Output:
0 load = x, shift_left_right = x, data_in = xxxxxxxx
1 load = 1, shift_left_right = 0, data_in = 00000001
2 load = 1, shift_left_right = 1, data_in = 10100101
3 load = 1, shift_left_right = 1, data_in = 00100100
4 load = 0, shift_left_right = 1, data_in = 00000000
5 load = 1, shift_left_right = 0, data_in = 10000001
6 load = 0, shift_left_right = 0, data_in = 00001001
*/